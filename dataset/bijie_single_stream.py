...
class SingleComposite(Dataset):
    ...
    def __create_composite(self, image, dem):
        ...
        if self.bands == "RGB&DEM":
            ...
            comp1 = np.concatenate([C1, C2, C3, C4], axis=-1)
    ...
    def __getitem__(self, idx):
        ...
        # Creating composites
        comp1 = self.__create_composite(image, dem)
        ...
        # Transformation
        if self.transform:
            comp1_tensor, label_tensor = self.transform(comp1_tensor, label_tensor)
        
        return comp1_tensor, label_tensor